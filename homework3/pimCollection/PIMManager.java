...
public class PIMManager 
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		while(true)
		{
			...
			else if(command.equals("Collection"))
			{
				...
				list((ArrayList<PIMEntity>)(collection.getTodos()));
				list((ArrayList<PIMEntity>)(collection.getItemsForDate(new GregorianCalendar(2016, 3, 19))));
			}
	...
	public static void list(ArrayList<PIMEntity> e)
	{
		System.out.println("There are "+e.size()+" items.");
		if(!e.isEmpty())
		{
			for(int i=1;i<=e.size();i++)
				System.out.println("Item "+i+":"+e.get(i-1));
		}
	}
